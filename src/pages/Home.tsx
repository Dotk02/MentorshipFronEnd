...
function Home() {
  ...
  return (
    <div className="font-sans">
      ...
      {/* Hero Section */}
      <section className="bg-cover bg-center text-white text-center py-24 px-4" style={{ backgroundImage: `url(${mentorImage})` }}>
        ...
        <div className="flex justify-center gap-12 mt-10 text-xl font-semibold">
          <div><p>120+</p><span className="text-sm font-normal">Active Mentors</span></div>
          <div><p>600+</p><span className="text-sm font-normal">Successful Matches</span></div>
          <div><p>45%</p><span className="text-sm font-normal">Satisfaction Rate</span></div>
        </div>
      </section>
